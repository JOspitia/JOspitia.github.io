    ...
    case 'whatsapp':
      return (
        <svg
          ...
          fill="currentColor"
        >
          {/* WhatsApp glyph — phone receiver inside a speech-bubble outline. */}
 ...
 * email-vs-external distinction. PR 14: WhatsApp added as link with
 * prefilled message (treated like any other external link).
 */
